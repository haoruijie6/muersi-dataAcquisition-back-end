...
import com.common.utils.minio.MinioUtils;
...
public class CommonController {
     ...
     * @author MZ
     * @date 2023/4/1
     * @description 上传到远端服务器
     */
    @PostMapping("/common/uploadFileOrigin")
    public AjaxResult uploadFileOrigin(MultipartFile file) {
        String fileName = file.getOriginalFilename();
        assert fileName != null;
        String fileSuffix = fileName.split("\\.")[1];
        String fileNewName = IdUtil.simpleUUID() + '.' + fileSuffix;
        MinioUtils.putObject(bucketName, file, fileNewName);
        return AjaxResult.success(endpoint + "/" + bucketName + "/" + fileNewName);
    }
