package com.common.utils.minio;
...
public class MinioUtils {
     ...
     * @param objectName 对象名
     */
    public static ObjectWriteResponse putObject(String bucketName, MultipartFile file, String objectName) {
        try {
            InputStream inputStream = file.getInputStream();
            return minioClient.putObject(
     ...
     * @param objectName 对象名
     */
    public static void putFile(String bucketName, MultipartFile file, String objectName) {
        try {
            InputStream inputStream = file.getInputStream();
